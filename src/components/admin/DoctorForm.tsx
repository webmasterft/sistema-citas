...
export function DoctorForm({ onClose, onSuccess, initialData }: DoctorFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const full_name = `${firstName1} ${firstName2} ${lastName1} ${lastName2}`
      .replace(/\s+/g, " ")
      .trim();
    ...
    try {
      ...
      console.log(
        "DoctorForm: Submitting payload to doctors_directory via Server Action:",
        doctorPayload
      );
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder={
                        initialData ? "Dejar en blanco para no cambiar" : "Min. 6 caracteres"
                      }
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2 relative">
                    ...
                    <div className="relative">
                      ...
                      >
                        <span
                          className={
                            selectedSpecialty ? "text-foreground" : "text-muted-foreground text-xs"
                          }
                        >
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      required
                      className="w-full rounded-[6px] border border-slate-300 bg-slate-50 px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors text-slate-800 placeholder:text-slate-400 font-mono"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full h-[42px] rounded-[6px] border border-slate-300 bg-slate-50 px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors appearance-none cursor-pointer text-slate-800"
                    >
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <textarea
                      ...
                      className="w-full rounded-[6px] border border-slate-300 bg-slate-50 px-3 py-2.5 text-sm outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors resize-none text-slate-800 placeholder:text-slate-400"
                      placeholder="Av. Principal N23..."
                    />
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-xl bg-primary/5 border border-primary/20">
                  ...
                  <label htmlFor="doc-terms" className="text-sm leading-tight cursor-pointer">
                    <span className="font-bold flex items-center gap-1.5 mb-1">
                      <ShieldCheck className="size-4 text-primary" /> Aceptación de Términos
                    </span>
                    Certifico que la información proporcionada es veraz y acepto los términos de uso
                    del sistema MedApp para la gestión de pacientes y datos clínicos.
                  </label>
                </div>
              </div>
            </div>
